...
export const useConversationStore = (): UseConversationStore => {
    ...
    useEffect(() => {
        try {
            ...
            console.log('Raw saved ', saved); // Debug log

            if (saved && saved !== 'NaN') {  // ← Add this check
                const parsed = JSON.parse(saved);
                console.log('Parsed data type:', typeof parsed, 'value:', parsed); // Debug log
                ...
                if (Array.isArray(parsed)) {
                    ...
                    }).filter(Boolean); // Remove any null conversations

                    console.log('Processed conversations:', withDates); // Debug log
